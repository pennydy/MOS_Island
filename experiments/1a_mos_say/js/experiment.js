...
function make_slides(f) {
    ...
    slides.practice_bg_good_2 = slide({
        ...
        present_handle : function(stim) {
          ...
          $(".err_good").hide();
          this.stim = stim;
          var context = "Hanako said: Vera didn't drive to Michigan.";
          $(".context").html(context);
          exp.context = context;
      ...
      slides.practice_bg_bad_1 = slide({
        ...
        present_handle : function(stim) {
            ...
            $(".err_good").hide();
            this.stim = stim;
            var context = "Hanako said: Hank didn't buy the red car.";
            $(".context").html(context);
            exp.context = context;
...
function init() {
    ...
    var critical_mos = _.shuffle([
      {
        ...
        "verb": "whisper",
        "condition": "mos",
        "context_full": "Scott said: John didn't whisper that Mary met with the lawyer.",
      ...
      },
      {
        ...
        "verb": "stammer",
        "condition": "mos",
        "context_full": "Scott said: Emma didn't stammer that Kevin lost the keys.",
      ...
      },
      {
        ...
        "verb": "mumble",
        "condition": "mos",
        "context_full": "Scott said: Howard didn't mumble that Alex bought a birthday cake.",
      ...
      },
      {
        ...
        "verb": "mutter",
        "condition": "mos",
        "context_full": "Scott said: Laura didn't mutter that Brandon broke his laptop.",
      ...
      },
      {
        ...
        "verb": "shout",
        "condition": "mos",
        "context_full": "Scott said: Bill didn't shout that Dan knew the professor.",
      ...
      },
      {
        ...
        "verb": "scream",
        "condition": "mos",
        "context_full": "Scott said: Amy didn't scream that Charlie saw the robber.",
      ...
      },
      {
        ...
        "verb": "yell",
        "condition": "mos",
        "context_full": "Scott said: Jake didn't yell that Yumi found the wallet.",
      ...
      },
      {
        ...
        "verb": "groan",
        "condition": "mos",
        "context_full": "Scott said: Ashley didn't groan that Hasan talked to the detectives.",
      ...
      },
      {
        ...
        "verb": "whine",
        "condition": "mos",
        "context_full": "Scott said: Yash didn't whine that Ming forgot her phone. ",
      ...
      },
      {
        ...
        "verb": "murmur",
        "condition": "mos",
        "context_full": "Scott said: Fatima didn't murmur that Omar had dinner with his manager.",
      ...
      },
      {
        ...
        "verb": "shriek",
        "condition": "mos",
        "context_full": "Scott said: Igor didn't shriek that Penny won the lottery.",
      ...
      },
      {
        ...
        "verb": "moan",
        "condition": "mos",
        "context_full": "Scott said: Chandler didn't moan that Tia brought her parents.",
    ...
    var critical_say = _.shuffle([
      ...
      },
      {
        ...
        "target_full": "Hanako said: Then what did Emily say that Paul drafted?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Sally didn't say that Tony would visit George.",
        "target_full": "Hanako said: Then who did Sally say that Tony would visit?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Tim didn't say that Jason drank the beer. ",
        "target_full": "Hanako said: Then what did Tim say that Jason drank?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Charlie didn't say that Maddie would call her roommate.",
        "target_full": "Hanako said: Then who did Charlie say that Maddie would call?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Kate didn't say that Zack broke the plates.",
        "target_full": "Hanako said: Then what did Kate say that Zack broke?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Ben didn't say that Laura ordered pizza.",
        "target_full": "Hanako said: Then what did Ben say that Laura ordered?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Danny didn't say that Jennifer got a cat.",
        "target_full": "Hanako said: Then what did Danny say that Jennifer got?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Nancy didn't say that Julian ate the cupcake.",
        "target_full": "Hanako said: Then what did Nancy say that Julian ate?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Jessie didn't say that Michelle borrowed the computer.",
        "target_full": "Hanako said: Then what did Jessie say that Michelle borrowed?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Tom didn't say that Sarah admired her friend. ",
        "target_full": "Hanako said: Then who did Tom say that Sarah admired?",
      ...
      },
      {
        ...
        "verb": "say",
        "condition": "say",
        "context_full": "Scott said: Noah didn't say that Sharon wanted a dog.",
        "target_full": "Hanako said: Then what did Noah say that Sharon wanted?",
    ...
    var filler_good = _.shuffle([
      ...
      },
      {
        ...
        "verb": "suggest",
        "condition": "filler_good",
        "context_full": "Scott said: Grace didn't suggest that Karen wrote a book.",
        "target_full": "Hanako said: Then what did Grace suggest that Karen wrote?",
      ...
      },
      {
        ...
        "verb": "believe",
        "condition": "filler_good",
        "context_full": "Scott said: Jean didn't believe that Grant adopted a kitten.",
        "target_full": "Hanako said: Then what did Jean believe that Grant adopted?",
      ...
      },
      {
        ...
        "verb": "expect",
        "condition": "filler_good",
        "context_full": "Scott said: Roger didn't expect that Andy would take the jacket.",
        "target_full": "Hanako said: Then what did Roger expect that Andy would take?",
      ...
      },
      {
        ...
        "verb": "guess",
        "condition": "filler_good",
        "context_full": "Scott said: Julina didn't guess that Charlie received a message.",
      ...
      },
      {
        ...
        "verb": "suspect",
        "condition": "filler_good",
        "context_full": "Scott said: Sebrina didn't suspect that James would cancel the trip.",
        "target_full": "Hanako said: Then who suspect that James would cancel the trip?",
      ...
      },
      {
        ...
        "verb": "expect",
        "condition": "filler_good",
        "context_full": "Scott said: Ryan didn't expect that Leon heard the news.",
        "target_full": "Hanako said: Then who expected that Leon heard the news?",
      ...
      },
      {
        ...
        "verb": "confirm",
        "condition": "filler_good",
        "context_full": "Scott said: Juliet didn't confirm that Sebastian would come to the party.",
        "target_full": "Hanako said: Then who confirmed that Sebastian would come to the party?",
    ...
    var filler_bad = _.shuffle([
      {
        ...
        "context_full": "Scott said: Helen didn't think that Rob and Marc cut the bread. ",
        "target_full": "Hanako said: Then who did Helen think that Rob and cut the bread?",
      ...
      },
      {
        ...
        "verb": "suspect",
        "condition": "filler_bad",
        "context_full": "Scott said: Tim didn't suspect that Liz and Jason drank the beer. ",
        "target_full": "Hanako said: Then who did Tim suspect that Liz and drank the beer?",
      ...
      },
      {
        ...
        "verb": "believe",
        "condition": "filler_bad",
        "context_full": "Scott said: Larry didn't believe that Karl and Nick cooked dinner.",
        "target_full": "Hanako said: Then who did Larry believe that Karl and cooked dinner?",
      ...
      },
      {
        ...
        "verb": "expect",
        "condition": "filler_bad",
        "context_full": "Scott said: Ben didn't expect that Judith and Eleanor would solve the puzzle.",
        "target_full": "Hanako said: Then who did Ben expect that Judith and would solve the puzzle?",
      ...
      },
      {
        ...
        "verb": "suggest",
        "condition": "filler_bad",
        "context_full": "Scott said: Amelia didn't suggest that Frank and Lisa were in the office.",
        "target_full": "Hanako said: Then who did Amelia suggest that Frank and were in the office?",
      ...
      },
      {
        ...
        "verb": "spectulate",
        "condition": "filler_bad",
        "context_full": "Scott said: Michael didn't speculate that Robert and Eric would leave the team.",
        "target_full": "Hanako said: Then who did Michael speculate that Robert and would leave the team?",
      ...
      },
      {
        ...
        "verb": "imply",
        "condition": "filler_bad",
        "context_full": "Scott said: Rui didn't imply that Carol's brother signed the contract.",
      ...
      },
      {
        ...
        "verb": "expect",
        "condition": "filler_bad",
        "context_full": "Scott said: Jamal didn't expect that the book about astronomy was on the shelf.",
        "target_full": "Hanako said: Then what did Jamal expect that the book about was on the shelf? ",
      ...
      },
      {
        ...
        "verb": "insist",
        "condition": "filler_bad",
        "context_full": "Scott said: Ted didn't insist that Eva's uncle should stay for dinner. ",
